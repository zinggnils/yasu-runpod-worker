...
GEMINI_DESHADOW_PROMPT = "remove shadows on face"
...
def run_gemini_remove_face_shadows(img: Image.Image) -> tuple[Image.Image | None, str | None]:
    """Gemini pass on matte-clean portrait: reduce cast shadows on the face."""
    if not GEMINI_API_KEY:
        return None, "GEMINI_API_KEY not set"
